...
<%int cid=Integer.parseInt(request.getParameter("c_id"));%>
 ...
 <script>
  ...
  var result = confirm("Do You Really Want to Delete The Contact");
 ...
 if (result==true) 
    {
	 ...
	 try
	 {
	 	...
	 	cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/contact_project","root","");

	     stmt = cn.createStatement();
	    // String sql = "delete  FROM  `contacts` WHERE c_id ='" + cid + "'" ;
	     String sql = "UPDATE `contacts` SET deleted=0 WHERE  c_id ='" + cid + "'" ;
